    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-xl-12">
                ...
                <form action="/admin/edit-logo-submit" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card" >
                        <h5 class="card-header">Thumbnail</h5>
                        @if(Session::has('message'))
                       <script>
                        alert('  <p style="color: rgb(34, 223, 34);  position: fixed;left: 45%;top:30%;">{{Session::get('message')}}</p>')
                    </script>
                        ...
                        <div class="card-body">
                            <div class="mb-3 " style="display: flex;  flex-direction: column;">
                                ...
                                <input class="form-control" type="file" name="thumbnail" id="image" value="../../uploads/{{$objLogo[0]->thumbnail}}" />
