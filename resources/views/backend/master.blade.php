            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-bolt-circle"></i>
                            <div data-i18n="Layouts">Repairer</div>
                        </a>

                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/list-repairer" class="menu-link">
                                    <div data-i18n="Without menu">View Post</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/add-repairer" class="menu-link">
                                    <div data-i18n="Without menu">Add Post</div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/admin/log-activity/1" class="menu-link">
                                    <div data-i18n="Without menu">View Post</div>
                                </a>
                            </li>
                        </ul>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        ...
                                        {{-- <img src="{{url('uploads/'.Auth::User()->profile)}}" alt class="w-px-40 h-auto rounded-circle" /> --}}
                                    </div>
                                </a>
